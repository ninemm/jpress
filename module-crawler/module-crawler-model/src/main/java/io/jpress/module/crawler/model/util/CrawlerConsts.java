...
public class CrawlerConsts {
    ...
    public static final int CUP_AVAILABLE_PROCESSORS = Runtime.getRuntime().availableProcessors();
    ...
    /** 西刺代理事件名称*/
    public static final String XICI_EVENT_NAME = "xiciEventName";

    /** 小舒代理事件名称*/
    public static final String XIAOSHU_EVENT_NAME = "xiaoShuEventName";

    /** 快代理事件名称*/
    public static final String KUAIPROXY_EVENT_NAME = "kuaiEventName";

    /** 泥马代理事件名称*/
    public static final String NIMAPROXY_EVENT_NAME = "nimaEventName";

    /** 旗云代理事件名称*/
    public static final String QIYUNPROXY_EVENT_NAME = "qiyunEventName";

    /** 校验代理事件名称*/
    public static final String VALIDATE_PROXY_EVENT_NAME = "validateProxyEventName";
