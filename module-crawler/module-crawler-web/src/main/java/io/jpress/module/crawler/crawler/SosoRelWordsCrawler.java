...
public class SosoRelWordsCrawler extends AbstractRamCrawler {

    private static final Log _LOG = Log.getLog(SosoRelWordsCrawler.class);

    public SosoRelWordsCrawler(KeywordParamVO keyword, String searchType, Integer pageIndex) {
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        _LOG.info("关键词：" + keyword + ", 在360中的相关(搜索)关键词个数：" + results.size());
