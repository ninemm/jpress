...
public class BaiduRelWordsCrawler extends AbstractRamCrawler {

    private static final Log _LOG = Log.getLog(BaiduRelWordsCrawler.class);

    public BaiduRelWordsCrawler(KeywordParamVO keyword, String searchType, Integer pageIndex) {
    ...
    public void visit(Page page, CrawlDatums next) {
        ...
        _LOG.info("关键词：" + keyword + ", 在百度中的相关(搜索)关键词个数：" + results.size());
    ...
    public String createUrl(String keyword, Integer pageIndex) {
        try {
            ...
            return String.format("http://www.baidu.com/s?wd=%s", keyword);
