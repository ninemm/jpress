...
@EventConfig(action = KeywordConsts.ADD_KEYWORD_EVENT_NAME)
public class AddKeywordEventListener implements JbootEventListener {
    ...
    private String getDistinctInsertSQL(String title, Object parentId, Object categoryId, String categoryName,
        ...
        StringBuilder sqlBuilder = new StringBuilder("insert ignore into c_keyword(`title`, `parent_id`, `category_id`,");
        sqlBuilder.append(" `category_name`, `num`, `pinyin`, `source`, `level`, `status`, `created`) values(");
