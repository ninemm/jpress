...
@RequestMapping(value = "/admin/keyword", viewPath = JPressConsts.DEFAULT_ADMIN_VIEW)
public class _KeywordController extends AdminControllerBase {
    ...
    @AdminMenu(text = "关键词", groupId = "keyword", order = 1)
    public void index() {

        List<KeywordCategory> list = categoryService.findAll();
        set("categoryList", list);

        render("keyword/keyword_list.html");
    }
    ...
    public void edit() {
        ...
        set("categoryList", list);
        render("keyword/keyword_edit.html");
    }
    ...
    public void upload() {
        List<KeywordCategory> list = categoryService.findAll();
        set("categoryList", list);
        render("keyword/keyword_import.html");
    }
